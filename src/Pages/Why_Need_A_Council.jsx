...
import "./Why_Need_A_Council.css"

const Why_Need_A_Council = () => {
  return (
    <div>
      <NavbarHome/>
      <div className='top'>
        <h4>Why Need A Council</h4>
      </div>
      <div className='eachDiv'>
        <div className='special'>
        <h5>Recognizing the Constitution of the Republic of South Africa Act 108 of 1996 inter alia, section 9 on equality and unfair discrimination in the Bill of Rights states the imperative of redressing historical and social inequalities;</h5>
        </div>
        <p>Further recognizing ​ that the Broad Based Black Economic Empowerment (B­BBEE) Amendment Act of 2014 seeks to promote the achievement of the right to equality, increase broad based and effective participation of Black people in the economy and promote equal opportunity and equal access to government services; and the accompanying amended BBBEE Generic Code of Good Practice including necessary score card and the empowerment elements contained therein; Also considering the Electronic Communications Amendment Act No.1of2014 seeks to promote the empowerment of Black people, with particular reference to women, youth and people with disabilities; and to promote SMMEs in the ICT sector. In order to address certain inequalities in the Information Communication Technology (ICT) sector as identified by government in terms of the Codes of Good Practice as being of national strategic importance. Stakeholders made up of the industry associations, NEDLAC Community constituency and the DTPS signed and adopted the ICT Sector Code.</p>
      </div>
      <div className='eachDiv'>
        <h5>INTRODUCTION</h5>
...
export default Why_Need_A_Council